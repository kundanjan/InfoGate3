...
public class MouseRecords extends AppCompatActivity
{
    ...
    static String url="https://infogateapi.onrender.com/add_mouse";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                ...
                {
                    RequestQueue requestQueue = Volley.newRequestQueue(MouseRecords.this);
                    sendMouseData(requestQueue,nameBrand,suppaddress,dateReceipt,Integer.parseInt(costcomp),DSR_no,nameDepart,nameLab,SR_no);
    ...
    public static void sendMouseData(RequestQueue requestQueue, String brandName, String supplierAddress,
