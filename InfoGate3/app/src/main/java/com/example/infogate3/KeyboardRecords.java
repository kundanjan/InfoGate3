...
public class KeyboardRecords extends AppCompatActivity {
    ...
    static String url="https://infogateapi.onrender.com/add_keyboard";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    RequestQueue requestQueue = Volley.newRequestQueue(KeyboardRecords.this);
                    sendKeyboardData(requestQueue,nameBrand,suppaddress,dateReceipt,Integer.parseInt(costcomp),DSR_no,nameDepart,nameLab,SR_no);
    ...
    public static void sendKeyboardData(RequestQueue requestQueue, String brandName, String supplierAddress,
