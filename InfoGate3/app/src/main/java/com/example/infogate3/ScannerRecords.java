...
public class ScannerRecords extends AppCompatActivity
{
    ...
    static String url="https://infogateapi.onrender.com/add_scanner";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    RequestQueue requestQueue = Volley.newRequestQueue(ScannerRecords.this);
                    sendScannerData(requestQueue,nameBrand,suppaddress,dateReceipt,Integer.parseInt(costcomp),DSR_no,nameDepart,nameLab,SR_no);
    ...
    public static void sendScannerData(RequestQueue requestQueue, String brandName, String supplierAddress,
